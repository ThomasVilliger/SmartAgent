   ...
   public class PiFaceMain
    {
        ...
        private static PiFaceDevice piFaceDevice = new PiFaceDevice();
        ...
        public  PiFaceMain()
        {
            ...
            cycleMachines.Add(new CycleMachine(piFaceDevice, new CycleMachineConfiguration { MachineName = "MachineXY", CycleInputPin = 0, MachineId = 999, MachineStateTimeOut = 15000 })); // TODO do this foreach CycleMachine in configuration ressource
        ...
        public static void WritePiFaceInput(int pin, bool value)
        {
            if (pin <= piFaceDevice.NumberOfInputs)
            {
                piFaceDevice.Inputs[pin].InputValue = value;
            }
